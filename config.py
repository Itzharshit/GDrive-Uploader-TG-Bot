...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5048583254:AAEFCQ06tDEdRIBoI-jHKo7Xy9st3U95RUc' # Get it from https://t.me/BotFather
    APP_ID = '13443315' # Get it from my.telegram.org/apps
    API_HASH = 'f43bd135fe417fdec2a79cb1a1804078' # Get it from my.telegram.org/apps
